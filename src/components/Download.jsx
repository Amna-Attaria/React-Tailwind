        ...
        <section class="max-w-6xl mx-auto">
          <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
            ...
            <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
              <h2 class="text-3xl font-semibold tracking-tight text-black lg:text-4xl">
                Download Our Free Mobile App
              </h2>

              <p class="block max-w-2xl mt-4 text-gray-500">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aut
                corporis esse dolorum, illum, consectetur earum provident alias
                dolore omnis quis tempore voluptatum excepturi ea numquam?
                Aperiam fugiat consequuntur nostrum odio.
              </p>
              ...
              <div class="mt-6 sm:-mx-2">
                ...
                <a href="#" class="inline-flex items-center justify-center w-full px-5 py-3 mt-4 overflow-hidden text-white transition-colors duration-300 bg-blue-600 rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0 hover:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
